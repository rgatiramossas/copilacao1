...
export function DanosVeiculoGrid({ 
  ...
  return (
    <div className="grid grid-cols-3 gap-1 mt-2 max-w-[1400px] mx-auto px-1" style={{ minWidth: 'min-content' }}>
      {/* Linha 1 */}
      <Card className="flex flex-col h-[200px] sm:h-[160px]">
        <CardContent className="p-1 sm:p-2 flex-1 flex flex-col justify-between">
      ...
      {/* Espaço para foto */}
      <Card className="flex items-center justify-center flex-col h-[220px] sm:h-[180px]">
        <CardContent className="p-2 sm:p-4 flex flex-col items-center justify-center flex-1 flex-col justify-between">
