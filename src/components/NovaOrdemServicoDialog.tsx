...
interface NovaOrdemServicoDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSucesso: (novaOS: OrdemServico) => void;
}

const NovaOrdemServicoDialog: React.FC<NovaOrdemServicoDialogProps> = ({ 
  isOpen, 
  onClose, 
  onSucesso 
}) => {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    try {
      const novaOS = ordemServicoService.addOrdemServico({
...
export default NovaOrdemServicoDialog;
